            ...
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    ...
                    @if (Auth::user() && Auth::user()->image_path !="")
                        <img src="<?=Auth::user()->image_path?>"  class="myImage rounded-circle" alt="Profile">
                    @else
                        <img src="{{asset('admin/assets/img/avatar.png')}}" class="myImage rounded-circle" alt="Profile">
                    @endif
