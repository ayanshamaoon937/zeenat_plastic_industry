...
{{--    <meta name="theme-color" content="#ffffff">--}}
    @if($settings->logo !="")
        <link rel="icon" type="image/png" sizes="16x16" href="{{$settings->logo}}">
    @else
    ...
    <link href="{{asset('admin/assets/css/upload_images.css')}}" rel="stylesheet">
...
{{--    dataTables CSS--}}
    ...
    <link href="{{asset('admin/assets/vendor/datatables/select.dataTables.min.css')}}" rel="stylesheet">
</head>
<body>
<div class="wrapper">
    <!-- End preloader -->
